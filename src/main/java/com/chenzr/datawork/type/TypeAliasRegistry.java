...
import com.chenzr.datawork.io.ResolverUtil;
import com.chenzr.datawork.io.Resources;
...
public class TypeAliasRegistry {
    ...
    public void registerAlias(String alias, Class<?> value) {
        ...
        if (TYPE_ALIASES.containsKey(key) && TYPE_ALIASES.get(key) != null && !TYPE_ALIASES.get(key).equals(value)) {
            throw new org.apache.ibatis.type.TypeException("The alias '" + alias + "' is already mapped to the value '" + TYPE_ALIASES.get(key).getName() + "'.");
        }
